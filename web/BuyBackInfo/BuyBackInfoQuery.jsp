...
<%
   ...
   <form method="post" name=buyBackInfoQueryForm action="BuyBackInfoManage?action=query">
	  ...
	  <td style="height: 14px">
          <img src="../images/list.gif" width=14px height=14px>商品进货退货管理--&gt;进货退货信息查询</td>
        </tr>
        <tr>
       ...
       商品名称:<input type=text size=10 name=GoodName>&nbsp;
        ...
        <br/>
          ...
          <input class="submit" name="Button" onclick="setDay(document.buyBackInfoQueryForm.StartDate);" style="width: 30px" type="button" value="选择">
          结束日期:
          <input type=text name=EndDate size=10/>
          <input class="submit" name="Button" onclick="setDay(document.buyBackInfoQueryForm.EndDate);" style="width: 30px" type="button" value="选择">
    ...
    <table width=700 border=0 cellpadding=2 align="center">
         <tr class="title">
           <td>商品编号</td><td>商品名称</td><td>商品类别</td><td>供应商</td><td>退货单价</td><td>退货数量</td><td>退货总价</td><td>退货日期</td><td>退货原因</td>
         </tr>
         <%
