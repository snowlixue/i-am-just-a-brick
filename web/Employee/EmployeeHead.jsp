...
<script>
	...
	function showMenu(menu,tableW)
	{
		switch (menu)
		{
			...
			case '2' :mArray = new Array('商品信息查询');mArrayURL = new Array('../GoodInfo/GoodInfoManage?action=query');break;
			case '3' :mArray = new Array('商品销售','个人业绩查询');mArrayURL = new Array('../SellInfo/SellGoods.jsp','../SellInfo/SelfSellInfoQuery.jsp');break;
			case '4' :mArray = new Array('商品库存查询','商品库存报警');mArrayURL = new Array('../GoodStockInfo/GoodStockQuery.jsp','../GoodStockInfo/GoodStockManage?action=warning');break;
			case '5' :mArray = new Array('修改密码','关于系统');mArrayURL = new Array('changePassword.jsp','../about.html');break;
		}
...
<table class="tbl" id="Table2" cellSpacing="0" cellPadding="0" width="760" border="0">
	<tr>
		<td background="../images/titl_bg.jpg" height="26" align="right">
			<!--   导航超链接   --> &nbsp;&nbsp; 
			<A href="../Reader/index.jsp"><font color="#ffffff">首 页</font></A>&nbsp;<font color="#ffffff">┊</font>
			...
			<A style="COLOR: black" href='../logout.jsp' onclick="javascript:return confirm('真的确定退出吗？');"><font color="#ffffff">退 出</font></A> &nbsp;&nbsp; 
			<!--   /导航主菜单   --></td>
	</tr>
	<tr>
