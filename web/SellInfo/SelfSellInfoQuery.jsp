...
%>
     <form method="post" name=SelfSellInfoQueryForm action="SellInfoManage?action=selfSellInfoQuery">
	  ...
	  <td style="height: 14px; width: 605px;">
          <img src="../images/list.gif" width=14px height=14px>商品销售管理--&gt;个人销售业绩查询</td>
        </tr>
        <tr>
          ...
          <input class="submit" name="Button" onclick="setDay(document.SelfSellInfoQueryForm.StartDate);" style="width: 30px" type="button" value="选择">
              结束日期<input type=text name=EndDate value='<%=EndDate %>' size=10/>
          <input class="submit" name="Button" onclick="setDay(document.SelfSellInfoQueryForm.EndDate);" style="width: 30px" type="button" value="选择">
